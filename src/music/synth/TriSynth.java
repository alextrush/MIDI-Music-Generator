...
public final class TriSynth extends Instrument{
    //----------------------------------------------
    // Instance variables
    //----------------------------------------------
     ...
     * @param sampleRate 
     */
    public TriSynth(int sampleRate){
    ...
    *  Constructor that sets sample rate and the filter cutoff frequency.
     ...
     */
     public TriSynth(int sampleRate, int filterCutoff){
    ...
    */
     public TriSynth(int sampleRate, int filterCutoff, int channels){
    ...
    public void createChain() throws AOException{
        Oscillator wt = new Oscillator(this, 
            Oscillator.TRIANGLE_WAVE, this.sampleRate, this.channels);
