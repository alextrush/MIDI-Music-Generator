...
public final class MultiSynth extends Instrument{
    //----------------------------------------------
    // Instance variables
    //----------------------------------------------
...
//    private double att, dec, sus, rel, tri, sq, sin, saw;
//    private Oscillator triangle, square, sine, sawtooth;
    private Filter filt;
     ...
     * @param sampleRate 
     */
    public MultiSynth(int sampleRate){
    ...
    *  Constructor that sets sample rate and the filter cutoff frequency.
     ...
     */
     public MultiSynth(int sampleRate, int filterCutoff){
    ...
    */
     public MultiSynth(int sampleRate, int filterCutoff, int channels){
